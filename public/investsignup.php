        ...
        <div class="logInMain">
            <div class="wrapper">
                <div class="LogInMain-col1">
                    <div class="SignUp-col1-header">
                        <h1>Sign Up</h1>
                    </div>
                    <div class="SignUp-col1-content">
                        <form action="../includes/signup.inc.php" method="post">
                            <input type="text" name="ufname" placeholder="FIRST NAME" required><br>
                            <input type="text" name="ulname" placeholder="LAST NAME" required><br>
                            ...
                            <div class="adds1">
                                <p class="">Already have an account? <a href="./invest.php">Click here to Log In</a></p>
                            </div>
                        </form>
                    </div>
                </div>
